...
//
//  EliotMenuTableViewController.swift
//  GrilleOrderNew
//
//  Created by Matthew Hawes on 12/6/18.
//

import UIKit
import MessageUI

class EliotMenuTableViewController: UITableViewController, UINavigationControllerDelegate {
    ...
    // there are 8 sections in this table
    ...
    let numberOfRowsAtSection: [Int] = [5, 4, 5, 3, 4, 7, 6, 1]
