//
//  QuincyMenuTableViewController.swift
//  GrilleOrderNew
//
...
class QuincyMenuTableViewController: UITableViewController, UINavigationControllerDelegate {
    ...
    let numberOfRowsAtSection: [Int] = [9, 2, 1, 2, 1]
