//
//  PforzheimerMenuTableViewController.swift
//  GrilleOrderNew
//
...
class PforzheimerMenuTableViewController: UITableViewController, UINavigationControllerDelegate {
    ...
    let numberOfRowsAtSection: [Int] = [4, 5, 3, 1]
